...
const tokenSchema = new Schema(
  {
    ...
    // ми прив'язуємо токени accessToken та refreshToken до юзера по його _userId і кажемо, що він _userId має бути обов'язково і мати референс (трансфер) на модель User з ./user.model
