...
//
//тестуємо auth/refresh: заходимо в sign-in (повторний вхід, перевірка паролю, та видача нової пари токенів),
// в нашому випадку все норм ми аутентифікацію успішно проходимо бо токен валідний,
// а потім ми заходимо на auth/refresh, тут ми забираємо токен згенерований в sign-in,
// видаляємо стару пару токенів і видаємо нову пар токенів
